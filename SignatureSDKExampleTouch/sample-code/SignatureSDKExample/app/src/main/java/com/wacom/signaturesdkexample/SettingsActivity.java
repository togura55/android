...
public class SettingsActivity extends Activity {
	...
	private CheckBox checkboxEnableTouch;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// ----
//		checkboxEnableTouch = new CheckBox(this);
		checkboxEnableTouch = (CheckBox) findViewById(R.id.checkbox_enable_touch);
		checkboxEnableTouch.setChecked(settingsPreferences.getEnableTouch());
	...
	public void onPause() {
		...
		settingsPreferences.setEnableTouch(checkboxEnableTouch.isChecked());
	}
	...
	public void getEnableTouch(View view){
	}
