...
public class SettingsPreferences {
    ...
    // --- added -----
    private static final String ENABLE_TOUCH = "enable_touch";
    ...
    // ----- added --------
    public void setEnableTouch(boolean state){
        SharedPreferences.Editor editor = settingsPreferences.edit();
        editor.putBoolean(ENABLE_TOUCH, state);
        editor.apply();
    }

    public boolean getEnableTouch(){
        return settingsPreferences.getBoolean(ENABLE_TOUCH, DEFAULT_ENABLE_TOUCH);
    }
}
